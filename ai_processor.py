...
resolution_status: Решено | Не решено
...
- Не решено — во всех остальных случаях: проблема не решена, дан промежуточный ответ, передана дальше, или пользователь должен ждать
...
{{
  ...
  "resolution_status": "одно из: Решено | Не решено",
  "needs_escalation": 0,
