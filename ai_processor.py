...
{{
  ...
  "user_problem_summary": "краткое описание проблемы 1-2 предложения. Обязательно укажи все идентификаторы из диалога: номер заказа, номер посылки, артикул, название закупки и любые другие конкретные обозначения",
